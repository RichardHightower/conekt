 ...
 * === Creating buffers
 * <p>
 * Buffers can create by using one of the static {@link io.smallvertx.core.buffer.Buffer#buffer} methods.
 * <p>
 ...
 * === Buffer length
 * <p>
 * Use {@link io.smallvertx.core.buffer.Buffer#length} to obtain the length of the buffer.
 * The length of a buffer is the index of the byte in the buffer with the largest index + 1.
 * <p>
 * === Copying buffers
 * <p>
 * Use {@link io.smallvertx.core.buffer.Buffer#copy} to make a copy of the buffer
 * <p>
 * === Slicing buffers
 * <p>
 * A sliced buffer is a new buffer which backs onto the original buffer, i.e. it does not copy the underlying data.
 * Use {@link io.smallvertx.core.buffer.Buffer#slice} to create a sliced buffers
 * <p>
 * === Buffer re-use
 * <p>
