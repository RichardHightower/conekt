 ...
 * <p>
 * You can't do much in Vert.x-land unless you can commune with a {@link io.smallvertx.core.Vertx} object!
 * <p>
 ...
 * ----
 * <p>
 * The {@link io.smallvertx.core.VertxOptions} object has many settings and allows you to configure things like clustering,
 ...
 * {@link io.smallvertx.core.VertxOptions} object before creating the Vertx object.
 * <p>
 * [[blocking_code]]
 ...
 * <p>
 * It's done by calling {@link io.smallvertx.core.Vertx#executeBlocking} specifying both the blocking code to execute and a
 ...
 * <p>
 * If you don't care about ordering you can call {@link io.smallvertx.core.Vertx#executeBlocking(Handler, boolean, Handler)}
 ...
 * == Async coordination
 * <p>
 * Coordination of multiple asynchronous results can be achieved with Vert.x {@link io.smallvertx.core.Future futures}.
 * <p>
 * {@link io.smallvertx.core.CompositeFuture#all} takes several futures arguments (up to 6) and returns a future that is
 ...
 * ----
 * <p>
 * The handler returned by {@link io.smallvertx.core.Future#completer()} completes the future.
 * <p>
 * {@link io.smallvertx.core.CompositeFuture#any} takes several futures arguments (up to 6) and returns a future that is
 ...
 * ----
 * <p>
 * {@link io.smallvertx.core.Future#compose} can be used for chaining futures:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * If you want to deploy a verticle as a worker verticle you do that with {@link io.smallvertx.core.DeploymentOptions#setWorker}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * You can deploy a verticle using one of the {@link io.smallvertx.core.Vertx#deployVerticle} method, specifying a verticle
 ...
 * <p>
 * The verticle name is used to look up the specific {@link io.smallvertx.core.spi.VerticleFactory} that will be used to
 ...
 * <p>
 * You can also programmatically register and unregister verticle factories using {@link io.smallvertx.core.Vertx#registerVerticleFactory}
 * and {@link io.smallvertx.core.Vertx#unregisterVerticleFactory} if you wish.
 * <p>
 ...
 * <p>
 * Deployments can be undeployed with {@link io.smallvertx.core.Vertx#undeploy}.
 * <p>
 ...
 * {@link io.smallvertx.core.DeploymentOptions#setIsolatedClasses(java.util.List)}-  an entry can be a fully qualified
 ...
 * class loader.
 * <p>
 * Extra classpath entries can also be provided with {@link io.smallvertx.core.DeploymentOptions#setExtraClasspath} so if
 ...
 * <p>
 * If you are embedding Vert.x and you have finished with it, you can call {@link io.smallvertx.core.Vertx#close} to close it
 * down.
 * <p>
 ...
 * {@link io.smallvertx.core.Verticle}, the execution is associated with a `Context`. Usually a context is an
 ...
 * <p>
 * To retrieve the context, use the {@link io.smallvertx.core.Vertx#getOrCreateContext()} method:
 * <p>
 * [source, $lang]
 * ----
 ...
 * {@link io.smallvertx.core.Context#runOnContext(Handler)}:
 * <p>
 * [source, $lang]
 * ----
 ...
 * ----
 * <p>
 * The context object also let you access verticle configuration using the {@link io.smallvertx.core.Context#config()}
 ...
 * <p>
 * To set a timer to fire once you use {@link io.smallvertx.core.Vertx#setTimer} method passing in the delay and a handler
 * <p>
 * [source,$lang]
 * ----
 ...
 * ==== Periodic Timers
 * <p>
 * You can also set a timer to fire periodically by using {@link io.smallvertx.core.Vertx#setPeriodic}.
 * <p>
 ...
 * <p>
 * In this case, you should consider using {@link io.smallvertx.core.Vertx#setTimer} instead. Once your treatment has
 ...
 * ==== Cancelling timers
 * <p>
 * To cancel a periodic timer, call {@link io.smallvertx.core.Vertx#cancelTimer} specifying the timer id. For example:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * For example if you have deployed a verticle which creates a {@link io.smallvertx.core.net.NetServer} which provides
 * {@link io.smallvertx.core.net.NetSocket} instances in it's handler, then it's best to always access that socket instance
 ...
 * {@link io.smallvertx.core.spi.metrics.VertxMetrics API Documentation}.
 * <p>
 * == OSGi
 * <p>
 ...
 * {@link io.smallvertx.core.VertxOptions#setClusterManager(io.vertx.core.spi.cluster.ClusterManager)}.
 * <p>
 * == Logging
 * <p>
