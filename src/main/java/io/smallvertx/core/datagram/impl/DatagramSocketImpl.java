...
public class DatagramSocketImpl extends ConnectionBase implements DatagramSocket, MetricsProvider {
    ...
    private Handler<io.smallvertx.core.datagram.DatagramPacket> packetHandler;

    public DatagramSocketImpl(VertxInternal vertx, DatagramSocketOptions options) {
        super(vertx, createChannel(options.isIpV6() ? io.smallvertx.core.datagram.impl.InternetProtocolFamily.IPv6 : io.smallvertx.core.datagram.impl.InternetProtocolFamily.IPv4,
    ...
    private static NioDatagramChannel createChannel(io.smallvertx.core.datagram.impl.InternetProtocolFamily family,
    ...
    @Override
    public synchronized DatagramSocket handler(Handler<io.smallvertx.core.datagram.DatagramPacket> handler) {
    ...
    private DatagramSocket listen(io.smallvertx.core.net.SocketAddress local, Handler<AsyncResult<DatagramSocket>> handler) {
    ...
    synchronized void handlePacket(io.smallvertx.core.datagram.DatagramPacket packet) {
        if (metrics.isEnabled()) {
