 ...
 * <p>
 * To use UDP you first need t create a {@link io.smallvertx.core.datagram.DatagramSocket}. It does not matter here if you only want to send data or send
 * and receive.
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * The returned {@link io.smallvertx.core.datagram.DatagramSocket} will not be bound to a specific port. This is not a
 ...
 * <p>
 * If you want to receive packets you need to bind the {@link io.smallvertx.core.datagram.DatagramSocket} by calling
 * `listen(...)}` on it.
 * <p>
 * This way you will be able to receive {@link io.smallvertx.core.datagram.DatagramPacket}s that were sent to the address and port on
 * which the {@link io.smallvertx.core.datagram.DatagramSocket} listens.
 * <p>
 * Beside this you also want to set a `Handler` which will be called for each received {@link io.smallvertx.core.datagram.DatagramPacket}.
 * <p>
 * The {@link io.smallvertx.core.datagram.DatagramPacket} has the following methods:
 * <p>
 * - {@link io.smallvertx.core.datagram.DatagramPacket#sender()}: The InetSocketAddress which represent the sender of the packet
 * - {@link io.smallvertx.core.datagram.DatagramPacket#data()}: The Buffer which holds the data which was received.
 * <p>
 ...
 * <p>
 * If you want to receive packets for specific Multicast group you need to bind the {@link io.smallvertx.core.datagram.DatagramSocket} by
 ...
 * {@link io.smallvertx.core.datagram.DatagramSocket} listens and also to those sent to the Multicast group.
 * <p>
 ...
 * <p>
 * When creating a {@link io.smallvertx.core.datagram.DatagramSocket} there are multiple properties you can set to
 * change it's behaviour with the {@link io.smallvertx.core.datagram.DatagramSocketOptions} object. Those are listed here:
 * <p>
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setSendBufferSize(int)} Sets the send buffer size in bytes.
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setReceiveBufferSize(int)} Sets the TCP receive buffer size
 * in bytes.
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setReuseAddress(boolean)} If true then addresses in TIME_WAIT
 * state can be reused after they have been closed.
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setTrafficClass(int)}
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setBroadcast(boolean)} Sets or clears the SO_BROADCAST socket
 * option. When this option is set, Datagram (UDP) packets may be sent to a local interface's broadcast address.
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setMulticastNetworkInterface(java.lang.String)} Sets or clears
 * the IP_MULTICAST_LOOP socket option. When this option is set, multicast packets will also be received on the
 * local interface.
 * - {@link io.smallvertx.core.datagram.DatagramSocketOptions#setMulticastTimeToLive(int)} Sets the IP_MULTICAST_TTL socket
 ...
 * {@link io.smallvertx.core.datagram.DatagramSocket#localAddress()}. This will only return an `InetSocketAddress` if you
 * bound the {@link io.smallvertx.core.datagram.DatagramSocket} with `listen(...)` before, otherwise it will return null.
 * <p>
