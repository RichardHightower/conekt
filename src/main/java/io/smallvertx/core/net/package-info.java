 ...
 * <p>
 * If you don't want the default, a server can be configured by passing in a {@link io.smallvertx.core.net.NetServerOptions}
 ...
 * <p>
 * To tell the server to listen for incoming requests you use one of the {@link io.smallvertx.core.net.NetServer#listen}
 * alternatives.
 * <p>
 ...
 * <p>
 * To find out the real port the server is listening on you can call {@link io.smallvertx.core.net.NetServer#actualPort()}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * To be notified when a connection is made you need to set a {@link io.smallvertx.core.net.NetServer#connectHandler(Handler)}:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * When a connection is made the handler will be called with an instance of {@link io.smallvertx.core.net.NetSocket}.
 * <p>
 ...
 * <p>
 * To read data from the socket you set the {@link io.smallvertx.core.net.NetSocket#handler(Handler)} on the
 * socket.
 * <p>
 * This handler will be called with an instance of {@link io.smallvertx.core.buffer.Buffer} every time data is received on
 * the socket.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * You write to a socket using one of {@link io.smallvertx.core.net.NetSocket#write}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * === Closed handler
 * <p>
 * If you want to be notified when a socket is closed, you can set a {@link io.smallvertx.core.net.NetSocket#closeHandler(Handler)}
 * on it:
 * <p>
 * [source,$lang]
 * ----
 ...
 * === Handling exceptions
 * <p>
 * You can set an {@link io.smallvertx.core.net.NetSocket#exceptionHandler(Handler)} to receive any
 ...
 * <p>
 * The address of the handler is given by {@link io.smallvertx.core.net.NetSocket#writeHandlerID()}
 * <p>
 * === Local and remote addresses
 * <p>
 * The local address of a {@link io.smallvertx.core.net.NetSocket} can be retrieved using {@link io.smallvertx.core.net.NetSocket#localAddress()}.
 * <p>
 * The remote address, (i.e. the address of the other end of the connection) of a {@link io.smallvertx.core.net.NetSocket}
 * can be retrieved using {@link io.smallvertx.core.net.NetSocket#remoteAddress()}.
 * <p>
 * === Sending files or resources from the classpath
 * <p>
 * Files and classpath resources can be written to the socket directly using {@link io.smallvertx.core.net.NetSocket#sendFile}. This can be a very
 ...
 * === Streaming sockets
 * <p>
 * Instances of {@link io.smallvertx.core.net.NetSocket} are also {@link io.smallvertx.core.streams.ReadStream} and
 * {@link io.smallvertx.core.streams.WriteStream} instances so they can be used to pump data to or from other
 ...
 * <p>
 * A non SSL/TLS connection can be upgraded to SSL/TLS using {@link io.smallvertx.core.net.NetSocket#upgradeToSsl(Handler)}.
 * <p>
 ...
 * <p>
 * Call {@link io.smallvertx.core.net.NetServer#close()} to close the server. Closing the server closes any open connections
 ...
 * <p>
 * If you don't want the default, a client can be configured by passing in a {@link io.smallvertx.core.net.NetClientOptions}
 * instance when creating it:
 * <p>
 * [source,$lang]
 * ----
 ...
 * === Making connections
 * <p>
 * To make a connection to a server you use {@link io.smallvertx.core.net.NetClient#connect(int, java.lang.String, Handler)},
 * specifying the port and host of the server and a handler that will be called with a result containing the
 * {@link io.smallvertx.core.net.NetSocket} when connection is successful or with a failure if connection failed.
 * <p>
 * [source,$lang]
 * ----
 ...
 * This is configured with {@link io.smallvertx.core.net.NetClientOptions#setReconnectInterval(long)} and
 * {@link io.smallvertx.core.net.NetClientOptions#setReconnectAttempts(int)}.
 * <p>
 ...
 * the {@link io.smallvertx.core.net.NetClientOptions} or {@link io.smallvertx.core.net.NetServerOptions} instances used
 * to create the servers or clients.
 * <p>
 * ==== Enabling SSL/TLS on the server
 * <p>
 * SSL/TLS is enabled with  {@link io.smallvertx.core.net.NetServerOptions#setSsl(boolean) ssl}.
 * <p>
 ...
 * <p>
 * If the {@link io.smallvertx.core.net.ClientOptionsBase#setTrustAll trustALl} is set to true on the client, then the client will
 ...
 * ----
 * <p>
 * If {@link io.smallvertx.core.net.ClientOptionsBase#setTrustAll trustAll} is not set then a client trust store must be
 ...
 * trust store location is set by using the function {@link io.smallvertx.core.net.JksOptions#setPath path} on the
 * {@link io.smallvertx.core.net.JksOptions jks options}. If a server presents a certificate during connection which is not
 ...
 * {@link io.smallvertx.core.net.JksOptions#setPath(java.lang.String) path} on the
 * {@link io.smallvertx.core.net.JksOptions jks options}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * longer be trusted. The {@link io.smallvertx.core.net.NetClientOptions#addCrlPath(java.lang.String) crlPath} configures
 * the crl list to use:
 * <p>
 * [source,$lang]
 * ----
