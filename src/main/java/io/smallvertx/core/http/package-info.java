 ...
 * <p>
 * If you don't want the default, a server can be configured by passing in a {@link io.smallvertx.core.http.HttpServerOptions}
 ...
 * <p>
 * To tell the server to listen for incoming requests you use one of the {@link io.smallvertx.core.http.HttpServer#listen}
 * alternatives.
 * <p>
 ...
 * <p>
 * To be notified when a request arrives you need to set a {@link io.smallvertx.core.http.HttpServer#requestHandler}:
 * <p>
 * [source,$lang]
 * ----
 ...
 * === Handling requests
 * <p>
 * When a request arrives, the request handler is called passing in an instance of {@link io.smallvertx.core.http.HttpServerRequest}.
 ...
 * <p>
 * The server request object allows you to retrieve the {@link io.smallvertx.core.http.HttpServerRequest#uri},
 * {@link io.smallvertx.core.http.HttpServerRequest#path}, {@link io.smallvertx.core.http.HttpServerRequest#params} and
 * {@link io.smallvertx.core.http.HttpServerRequest#headers}, amongst other things.
 * <p>
 * Each server request object is associated with one server response object. You use
 * {@link io.smallvertx.core.http.HttpServerRequest#response} to get a reference to the {@link io.smallvertx.core.http.HttpServerResponse}
 * object.
 * <p>
 ...
 * ==== Request version
 * <p>
 * The version of HTTP specified in the request can be retrieved with {@link io.smallvertx.core.http.HttpServerRequest#version}
 * <p>
 * ==== Request method
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#method} to retrieve the HTTP method of the request.
 * (i.e. whether it's GET, POST, PUT, DELETE, HEAD, OPTIONS, etc).
 * <p>
 * ==== Request URI
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#uri} to retrieve the URI of the request.
 * <p>
 ...
 * ==== Request path
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#path} to return the path part of the URI
 * <p>
 ...
 * ==== Request query
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#query} to return the query part of the URI
 * <p>
 * For example, if the request URI was:
 * <p>
 * a/b/c/page.html?param1=abc&param2=xyz
 ...
 * ==== Request headers
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#headers} to return the headers of the HTTP request.
 * <p>
 * This returns an instance of {@link io.smallvertx.core.MultiMap} - which is like a normal Map or Hash but allows multiple
 ...
 * ==== Request parameters
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerRequest#params} to return the parameters of the HTTP request.
 * <p>
 * Just like {@link io.smallvertx.core.http.HttpServerRequest#headers} this returns an instance of {@link io.smallvertx.core.MultiMap}
 ...
 * ==== Remote address
 * <p>
 * The address of the sender of the request can be retrieved with {@link io.smallvertx.core.http.HttpServerRequest#remoteAddress}.
 * <p>
 * ==== Absolute URI
 * <p>
 * The URI passed in an HTTP request is usually relative. If you wish to retrieve the absolute URI corresponding
 * to the request, you can get it with {@link io.smallvertx.core.http.HttpServerRequest#absoluteURI}
 * <p>
 * ==== End handler
 * <p>
 * The {@link io.smallvertx.core.http.HttpServerRequest#endHandler} of the request is invoked when the entire request,
 ...
 * <p>
 * To receive the body, you can use the {@link io.smallvertx.core.http.HttpServerRequest#handler}  on the request,
 ...
 * ----
 * <p>
 * The object passed into the handler is a {@link io.smallvertx.core.buffer.Buffer}, and the handler can be called
 ...
 * ----
 * <p>
 * This is such a common case, that Vert.x provides a {@link io.smallvertx.core.http.HttpServerRequest#bodyHandler} to do this
 ...
 * ==== Pumping requests
 * <p>
 * The request object is a {@link io.smallvertx.core.streams.ReadStream} so you can pump the request body to any
 * {@link io.smallvertx.core.streams.WriteStream} instance.
 * <p>
 ...
 * such a form *before* any of the body is read by calling {@link io.smallvertx.core.http.HttpServerRequest#setExpectMultipart}
 * with true, and then you should retrieve the actual attributes using {@link io.smallvertx.core.http.HttpServerRequest#formAttributes}
 ...
 * {@link io.smallvertx.core.http.HttpServerRequest#uploadHandler} on the request.
 * <p>
 * This handler will be called once for every
 * upload that arrives on the server.
 * <p>
 * The object passed into the handler is a {@link io.smallvertx.core.http.HttpServerFileUpload} instance.
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * The upload object is a {@link io.smallvertx.core.streams.ReadStream} so you can pump the request body to any
 * {@link io.smallvertx.core.streams.WriteStream} instance. See the chapter on <<streams, streams and pumps>> for a
 * detailed explanation.
 * <p>
 * If you just want to upload the file to disk somewhere you can use {@link io.smallvertx.core.http.HttpServerFileUpload#streamToFileSystem}:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * The server response object is an instance of {@link io.smallvertx.core.http.HttpServerResponse} and is obtained from the
 * request with {@link io.smallvertx.core.http.HttpServerRequest#response}.
 * <p>
 ...
 * <p>
 * Use {@link io.smallvertx.core.http.HttpServerResponse#setStatusCode} to set a different code.
 * <p>
 * You can also specify a custom status message with {@link io.smallvertx.core.http.HttpServerResponse#setStatusMessage}.
 * <p>
 * If you don't specify a status message, the default one corresponding to the status code will be used.
 * <p>
 * ==== Writing HTTP responses
 * <p>
 * To write data to an HTTP response, you use one the {@link io.smallvertx.core.http.HttpServerResponse#write} operations.
 * <p>
 ...
 * single call to the {@link io.smallvertx.core.http.HttpServerResponse#end(String)}
 * <p>
 ...
 * <p>
 * Once you have finished with the HTTP response you should {@link io.smallvertx.core.http.HttpServerResponse#end} it.
 * <p>
 ...
 * <p>
 * You can close the underlying TCP connection with {@link io.smallvertx.core.http.HttpServerResponse#close}.
 * <p>
 ...
 * closed after an idle time, then you configure {@link io.smallvertx.core.http.HttpServerOptions#setIdleTimeout}.
 * <p>
 * ==== Setting response headers
 * <p>
 * HTTP response headers can be added to the response by adding them directly to the
 * {@link io.smallvertx.core.http.HttpServerResponse#headers}:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * Or you can use {@link io.smallvertx.core.http.HttpServerResponse#putHeader}
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * Default is non-chunked. When in chunked mode, each call to one of the {@link io.smallvertx.core.http.HttpServerResponse#write}
 ...
 * <p>
 * To add trailers to the response, add them directly to the {@link io.smallvertx.core.http.HttpServerResponse#trailers}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * Or use {@link io.smallvertx.core.http.HttpServerResponse#putTrailer}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * If you were writing a web server, one way to serve a file from disk would be to open it as an {@link io.smallvertx.core.file.AsyncFile}
 * and pump it to the HTTP response.
 * <p>
 * Or you could load it it one go using {@link io.smallvertx.core.file.FileSystem#readFile} and write it straight to the response.
 * <p>
 ...
 * <p>
 * This is done by using {@link io.smallvertx.core.http.HttpServerResponse#sendFile}, and is usually more efficient for large
 ...
 * be notified when the file has been writen you can use {@link io.smallvertx.core.http.HttpServerResponse#sendFile(String, Handler)}
 * <p>
 ...
 * ==== Pumping responses
 * <p>
 * The server response is a {@link io.smallvertx.core.streams.WriteStream} instance so you can pump to it from any
 * {@link io.smallvertx.core.streams.ReadStream}, e.g. {@link io.smallvertx.core.file.AsyncFile}, {@link io.smallvertx.core.net.NetSocket},
 * {@link io.smallvertx.core.http.WebSocket} or {@link io.smallvertx.core.http.HttpServerRequest}.
 * <p>
 ...
 * <p>
 * To enable compression use can configure it with {@link io.smallvertx.core.http.HttpServerOptions#setCompressionSupported}.
 * <p>
 ...
 * <p>
 * You create an {@link io.smallvertx.core.http.HttpClient} instance with default options as follows:
 * <p>
 * [source,$lang]
 * ----
 ...
 * {@link io.smallvertx.core.http.HttpClient#getNow}.
 * <p>
 ...
 * general purpose request methods such as {@link io.smallvertx.core.http.HttpClient#request} which allow you to specify
 ...
 * before sending it.
 * <p>
 * To do this you can call one of the specific request methods such as {@link io.smallvertx.core.http.HttpClient#post} or
 * one of the general purpose request methods such as {@link io.smallvertx.core.http.HttpClient#request}.
 * <p>
 * These methods don't send the request immediately, but instead return an instance of {@link io.smallvertx.core.http.HttpClientRequest}
 ...
 * <p>
 * You can write headers to a request using the {@link io.smallvertx.core.http.HttpClientRequest#headers()} multi-map as follows:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * The headers are an instance of {@link io.smallvertx.core.MultiMap} which provides operations for adding, setting and removing
 * entries. Http headers allow more than one value for a specific key.
 * <p>
 * You can also write headers using {@link io.smallvertx.core.http.HttpClientRequest#putHeader}
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * Once you have finished with the HTTP request you must end it with one of the {@link io.smallvertx.core.http.HttpClientRequest#end}
 * operations.
 * <p>
 ...
 * <p>
 * You put the HTTP request into chunked mode using {@link io.smallvertx.core.http.HttpClientRequest#setChunked(boolean)}.
 * <p>
 ...
 * ==== Request timeouts
 * <p>
 * You can set a timeout for a specific http request using {@link io.smallvertx.core.http.HttpClientRequest#setTimeout(long)}.
 * <p>
 ...
 * {@link io.smallvertx.core.http.HttpClientRequest} instance:
 * <p>
 * [source,$lang]
 * ----
 ...
 * {@link io.smallvertx.core.http.HttpClientResponse} code:
 * <p>
 * [source, $lang]
 * ----
 ...
 * {@link io.smallvertx.core.http.HttpClientRequest#handler(Handler)}, for example:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * The {@link io.smallvertx.core.http.HttpClientRequest} instance is also a {@link io.smallvertx.core.streams.WriteStream} which means
 * you can pump to it from any {@link io.smallvertx.core.streams.ReadStream} instance.
 * <p>
 ...
 * <p>
 * You receive an instance of {@link io.smallvertx.core.http.HttpClientResponse} into the handler that you specify in of
 * the request methods or by setting a handler directly on the {@link io.smallvertx.core.http.HttpClientRequest} object.
 * <p>
 * You can query the status code and the status message of the response with {@link io.smallvertx.core.http.HttpClientResponse#statusCode}
 * and {@link io.smallvertx.core.http.HttpClientResponse#statusMessage}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * The {@link io.smallvertx.core.http.HttpClientResponse} instance is also a {@link io.smallvertx.core.streams.ReadStream} which means
 * you can pump it to any {@link io.smallvertx.core.streams.WriteStream} instance.
 * <p>
 * ==== Response headers and trailers
 * <p>
 * Http responses can contain headers. Use {@link io.smallvertx.core.http.HttpClientResponse#headers} to get the headers.
 * <p>
 * The object returned is a {@link io.smallvertx.core.MultiMap} as HTTP headers can contain multiple values for single keys.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * You use {@link io.smallvertx.core.http.HttpClientResponse#trailers} to get the trailers. Trailers are also a {@link io.smallvertx.core.MultiMap}.
 * <p>
 ...
 * <p>
 * As parts of the response body arrive, the {@link io.smallvertx.core.http.HttpClientResponse#handler} is called with
 * a {@link io.smallvertx.core.buffer.Buffer} representing the piece of the body:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * Or you can use the convenience {@link io.smallvertx.core.http.HttpClientResponse#bodyHandler(Handler)} which
 ...
 * <p>
 * The response {@link io.smallvertx.core.http.HttpClientResponse#endHandler} is called when the entire response body has been read
 * or immediately after the headers have been read and the response handler has been called if there is no body.
 * <p>
 * ==== Reading cookies from the response
 * <p>
 * You can retrieve the list of cookies from a response using {@link io.smallvertx.core.http.HttpClientResponse#cookies()}.
 * <p>
 ...
 * <p>
 * Vert.x allows you to set a {@link io.smallvertx.core.http.HttpClientRequest#continueHandler(Handler)} on the
 * client request object
 * <p>
 * This will be called if the server sends back a `Status: 100 (Continue)` response to signify that it is ok to send
 * the rest of the request.
 * <p>
 * This is used in conjunction with {@link io.smallvertx.core.http.HttpClientRequest#sendHead()}to send the head of the request.
 * <p>
 * Here's an example:
 * <p>
 * [source,$lang]
 ...
 * <p>
 * This is done by setting the option {@link io.smallvertx.core.http.HttpServerOptions#setHandle100ContinueAutomatically(boolean)}.
 * <p>
 * If you'd prefer to decide whether to send back continue responses manually, then this property should be set to
 * `false` (the default), then you can inspect the headers and call {@link io.smallvertx.core.http.HttpServerResponse#writeContinue()}
 ...
 * <p>
 * To enable compression set {@link io.smallvertx.core.http.HttpClientOptions#setTryUseCompression(boolean)} on the options
 ...
 * <p>
 * For pooling to work, keep alive must be true using {@link io.smallvertx.core.http.HttpClientOptions#setKeepAlive(boolean)}
 ...
 * <p>
 * The maximum number of connections to pool *for each server* is configured using {@link io.smallvertx.core.http.HttpClientOptions#setMaxPoolSize(int)}
 * <p>
 ...
 * <p>
 * Alternatively you can set idle timeout using {@link io.smallvertx.core.http.HttpClientOptions#setIdleTimeout(int)} - any
 ...
 * <p>
 * To enable pipe-lining, it must be enabled using {@link io.smallvertx.core.http.HttpClientOptions#setPipelining(boolean)}.
 ...
 * ===== WebSocket handler
 * <p>
 * The first way involves providing a {@link io.smallvertx.core.http.HttpServer#websocketHandler(Handler)}
 * on the server instance.
 * <p>
 * When a WebSocket connection is made to the server, the handler will be called, passing in an instance of
 * {@link io.smallvertx.core.http.ServerWebSocket}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * You can choose to reject the WebSocket by calling {@link io.smallvertx.core.http.ServerWebSocket#reject()}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * call {@link io.smallvertx.core.http.HttpServerRequest#upgrade()} on the server request.
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * The {@link io.smallvertx.core.http.ServerWebSocket} instance enables you to retrieve the {@link io.smallvertx.core.http.ServerWebSocket#headers() headers},
 * {@link io.smallvertx.core.http.ServerWebSocket#path() path}, {@link io.smallvertx.core.http.ServerWebSocket#query() query} and
 * {@link io.smallvertx.core.http.ServerWebSocket#uri() URI} of the HTTP request of the WebSocket handshake.
 * <p>
 * ==== WebSockets on the client
 * <p>
 * The Vert.x {@link io.smallvertx.core.http.HttpClient} supports WebSockets.
 * <p>
 * You can connect a WebSocket to a server using one of the {@link io.smallvertx.core.http.HttpClient#websocket} operations and
 * providing a handler.
 * <p>
 * The handler will be called with an instance of {@link io.smallvertx.core.http.WebSocket} when the connection has been made:
 * <p>
 * [source,$lang]
 * ----
 ...
 * {@link io.smallvertx.core.http.WebSocket#writeBinaryMessage(Buffer)}:
 * <p>
 * [source,$lang]
 * ----
 ...
 * {@link io.smallvertx.core.http.HttpClientOptions#setMaxWebsocketFrameSize(int)}
 ...
 * {@link io.smallvertx.core.http.WebSocketFrame#binaryFrame(Buffer, boolean)}
 * , {@link io.smallvertx.core.http.WebSocketFrame#textFrame(java.lang.String, boolean)} or
 * {@link io.smallvertx.core.http.WebSocketFrame#continuationFrame(Buffer, boolean)} and write them
 * to the WebSocket using {@link io.smallvertx.core.http.WebSocket#writeFrame(WebSocketFrame)}.
 * <p>
 ...
 * of shortcut methods to do that with {@link io.smallvertx.core.http.WebSocket#writeFinalBinaryFrame(Buffer)}
 * and {@link io.smallvertx.core.http.WebSocket#writeFinalTextFrame(String)}.
 * <p>
 * Here's an example:
 * <p>
 * [source,$lang]
 ...
 * <p>
 * To read frames from a WebSocket you use the {@link io.smallvertx.core.http.WebSocket#frameHandler(Handler)}.
 * <p>
 * The frame handler will be called with instances of {@link io.smallvertx.core.http.WebSocketFrame} when a frame arrives,
 * for example:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ==== Closing WebSockets
 * <p>
 * Use {@link io.smallvertx.core.http.WebSocket#close()} to close the WebSocket connection when you have finished with it.
 * <p>
 * ==== Streaming WebSockets
 * <p>
 * The {@link io.smallvertx.core.http.WebSocket} instance is also a {@link io.smallvertx.core.streams.ReadStream} and a
 * {@link io.smallvertx.core.streams.WriteStream} so it can be used with pumps.
 * <p>
