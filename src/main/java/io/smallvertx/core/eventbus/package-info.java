 ...
 * :toc: left
 * <p>
 * The {@link io.smallvertx.core.eventbus.EventBus event bus} is the *nervous system* of Vert.x.
 * <p>
 * There is a single event bus instance for every Vert.x instance and it is obtained using the method {@link io.smallvertx.core.Vertx#eventBus}.
 * <p>
 ...
 * ==== Types of messages
 * <p>
 * Out of the box Vert.x allows any primitive/simple type, String, or {@link io.smallvertx.core.buffer.Buffer buffers} to
 * be sent as messages.
 * <p>
 ...
 * You do this by defining a {@link io.smallvertx.core.eventbus.MessageCodec codec} for the objects you want to send.
 * <p>
 * === The Event Bus API
 * <p>
 ...
 * <p>
 * This simplest way to register a handler is using {@link io.smallvertx.core.eventbus.EventBus#consumer(String, Handler)}.
 * Here's an example:
 * <p>
 * [source,$lang]
 * ----
 ...
 * ----
 * <p>
 * When a message arrives for your handler, your handler will be called, passing in the {@link io.smallvertx.core.eventbus.Message message}.
 * <p>
 * The object returned from call to +consumer()+ is an instance of {@link io.smallvertx.core.eventbus.MessageConsumer}
 * <p>
 * This object can subsequently be used to unregister the handler, or use the handler as a stream.
 * <p>
 * Alternatively you can use {@link io.smallvertx.core.eventbus.EventBus#consumer(String, Handler)} to
 ...
 * <p>
 * If you want to be notified when this has completed, you can register a {@link io.smallvertx.core.eventbus.MessageConsumer#completionHandler completion handler}
 ...
 * <p>
 * To unregister a handler, call {@link io.smallvertx.core.eventbus.MessageConsumer#unregister}.
 * <p>
 * If you are on a clustered event bus, un-registering can take some time to propagate across the nodes, if you want to
 * be notified when this is complete use {@link io.smallvertx.core.eventbus.MessageConsumer#unregister(Handler)}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * ==== Publishing messages
 * <p>
 * Publishing a message is simple. Just use {@link io.smallvertx.core.eventbus.EventBus#publish} specifying the
 ...
 * <p>
 * You can send a message with {@link io.smallvertx.core.eventbus.EventBus#send}
 * <p>
 * [source,$lang]
 * ----
 ...
 * ==== The Message object
 * <p>
 * The object you receive in a message handler is a {@link io.smallvertx.core.eventbus.Message}.
 * <p>
 * The {@link io.smallvertx.core.eventbus.Message#body} of the message corresponds to the object that was sent or published.
 * <p>
 * The headers of the message are available with {@link io.smallvertx.core.eventbus.Message#headers}.
 * <p>
 * ==== Acknowledging messages / sending replies
 * <p>
 * When using {@link io.smallvertx.core.eventbus.EventBus#send} the event bus attempts to deliver the message to a
 * {@link io.smallvertx.core.eventbus.MessageConsumer} registered with the event bus.
 * <p>
 * In some cases it's useful for the sender to know when the consumer has received the message and "processed" it.
 * <p>
 * To acknowledge that the message has been processed the consumer can reply to the message by calling {@link io.smallvertx.core.eventbus.Message#reply}.
 * <p>
 ...
 * <p>
 * When sending a message with a reply handler you can specify a timeout in the {@link io.smallvertx.core.eventbus.DeliveryOptions}.
 * <p>
 ...
 * * The recipient has explicitly failed the message using {@link io.smallvertx.core.eventbus.Message#fail}
 * <p>
