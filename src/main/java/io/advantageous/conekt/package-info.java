 ...
 * == Async coordination
 * <p>
 * Coordination of multiple asynchronous results can be achieved with Vert.x {@link io.advantageous.conekt.Future futures}.
 * <p>
 * {@link io.advantageous.conekt.CompositeFuture#all} takes several futures arguments (up to 6) and returns a future that is
 ...
 * ----
 * <p>
 * The handler returned by {@link io.advantageous.conekt.Future#completer()} completes the future.
 * <p>
 * {@link io.advantageous.conekt.CompositeFuture#any} takes several futures arguments (up to 6) and returns a future that is
 ...
 * ----
 * <p>
 * {@link io.advantageous.conekt.Future#compose} can be used for chaining futures:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * If you want to deploy a verticle as a worker verticle you do that with {@link io.advantageous.conekt.DeploymentOptions#setWorker}.
 * <p>
 * [source,$lang]
 * ----
 ...
 * {@link io.advantageous.conekt.DeploymentOptions#setIsolatedClasses(java.util.List)}-  an entry can be a fully qualified
 ...
 * class loader.
 * <p>
 * Extra classpath entries can also be provided with {@link io.advantageous.conekt.DeploymentOptions#setExtraClasspath} so if
 ...
 * {@link io.advantageous.conekt.Context#runOnContext(Handler)}:
 * <p>
 * [source, $lang]
 * ----
 ...
 * <p>
 * For example if you have deployed a verticle which creates a {@link io.advantageous.conekt.net.NetServer} which provides
 * {@link io.advantageous.conekt.net.NetSocket} instances in it's handler, then it's best to always access that socket instance
