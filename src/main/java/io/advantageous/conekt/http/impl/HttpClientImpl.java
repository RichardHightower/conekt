...
import io.advantageous.conekt.net.impl.SSLHelper;
...
public class HttpClientImpl implements HttpClient, MetricsProvider {
    ...
    @Override
    public HttpClientRequest requestAbs(io.advantageous.conekt.http.HttpMethod method, String absoluteURI, Handler<HttpClientResponse> responseHandler) {
        Objects.requireNonNull(responseHandler, "no null responseHandler accepted");
        return requestAbs(method, absoluteURI).handler(responseHandler);
    }

    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, int port, String host, String requestURI, Handler<HttpClientResponse> responseHandler) {
        Objects.requireNonNull(responseHandler, "no null responseHandler accepted");
        return request(method, port, host, requestURI).handler(responseHandler);
    }

    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, String host, String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(method, options.getDefaultPort(), host, requestURI, responseHandler);
    }

    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, String requestURI) {
        return request(method, options.getDefaultPort(), options.getDefaultHost(), requestURI);
    }

    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(method, options.getDefaultPort(), options.getDefaultHost(), requestURI, responseHandler);
    }

    @Override
    public HttpClientRequest requestAbs(io.advantageous.conekt.http.HttpMethod method, String absoluteURI) {
    ...
    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, int port, String host, String requestURI) {
        return doRequest(method, host, port, requestURI, null);
    }

    @Override
    public HttpClientRequest request(io.advantageous.conekt.http.HttpMethod method, String host, String requestURI) {
    ...
    public HttpClientRequest get(int port, String host, String requestURI) {
        return request(io.advantageous.conekt.http.HttpMethod.GET, port, host, requestURI);
    }
    ...
    public HttpClientRequest get(int port, String host, String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(io.advantageous.conekt.http.HttpMethod.GET, port, host, requestURI, responseHandler);
    }
    ...
    public HttpClientRequest get(String requestURI) {
        return request(io.advantageous.conekt.http.HttpMethod.GET, requestURI);
    }

    @Override
    public HttpClientRequest get(String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(io.advantageous.conekt.http.HttpMethod.GET, requestURI, responseHandler);
    }

    @Override
    public HttpClientRequest getAbs(String absoluteURI) {
        return requestAbs(io.advantageous.conekt.http.HttpMethod.GET, absoluteURI);
    }

    @Override
    public HttpClientRequest getAbs(String absoluteURI, Handler<HttpClientResponse> responseHandler) {
        return requestAbs(io.advantageous.conekt.http.HttpMethod.GET, absoluteURI, responseHandler);
    }
    ...
    public HttpClientRequest delete(int port, String host, String requestURI) {
        return request(io.advantageous.conekt.http.HttpMethod.DELETE, port, host, requestURI);
    }
    ...
    public HttpClientRequest delete(int port, String host, String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(io.advantageous.conekt.http.HttpMethod.DELETE, port, host, requestURI, responseHandler);
    }
    ...
    public HttpClientRequest delete(String requestURI) {
        return request(io.advantageous.conekt.http.HttpMethod.DELETE, requestURI);
    }

    @Override
    public HttpClientRequest delete(String requestURI, Handler<HttpClientResponse> responseHandler) {
        return request(io.advantageous.conekt.http.HttpMethod.DELETE, requestURI, responseHandler);
    }

    @Override
    public HttpClientRequest deleteAbs(String absoluteURI) {
        return requestAbs(io.advantageous.conekt.http.HttpMethod.DELETE, absoluteURI);
    }

    @Override
    public HttpClientRequest deleteAbs(String absoluteURI, Handler<HttpClientResponse> responseHandler) {
        return requestAbs(io.advantageous.conekt.http.HttpMethod.DELETE, absoluteURI, responseHandler);
    }
    ...
    private HttpClientRequest doRequest(io.advantageous.conekt.http.HttpMethod method, String host, int port, String relativeURI, MultiMap headers) {
