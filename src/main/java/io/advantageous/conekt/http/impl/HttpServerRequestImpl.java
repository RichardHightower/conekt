...
public class HttpServerRequestImpl implements HttpServerRequest {
    ...
    private io.advantageous.conekt.http.HttpVersion version;
    private io.advantageous.conekt.http.HttpMethod method;
    private String uri;
    private String path;
    ...
    @Override
    public io.advantageous.conekt.http.HttpVersion version() {
        if (version == null) {
            ...
            if (nettyVersion == io.netty.handler.codec.http.HttpVersion.HTTP_1_0) {
                version = io.advantageous.conekt.http.HttpVersion.HTTP_1_0;
            } else if (nettyVersion == io.netty.handler.codec.http.HttpVersion.HTTP_1_1) {
                version = io.advantageous.conekt.http.HttpVersion.HTTP_1_1;
            } else {
    ...
    public io.advantageous.conekt.http.HttpMethod method() {
        if (method == null) {
            ...
            try {
                method = io.advantageous.conekt.http.HttpMethod.valueOf(sMethod);
