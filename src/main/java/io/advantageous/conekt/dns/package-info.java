 ...
 * ----
 * <p>
 * Be aware that the List will contain the {@link io.advantageous.conekt.dns.MxRecord} sorted by the priority of them, which
 * means MX records with smaller priority coming first in the List.
 * <p>
 * The {@link io.advantageous.conekt.dns.MxRecord} allows you to access the priority and the name of the MX record by offer methods for it like:
 * <p>
 * [source,$lang]
 * ----
 ...
 * <p>
 * The {@link io.advantageous.conekt.dns.SrvRecord} allows you to access all informations contained in the SRV record itself:
 * <p>
 * [source,$lang]
 * ----
