...
public class NetTest extends VertxTestBase {
    ...
    public void testClientOptions() {
        ...
        TestUtils.assertIllegalArgumentException(() -> options.setReconnectInterval(0));
        rand = TestUtils.randomPositiveInt();
    ...
    public void testConnectInvalidPort() {
        TestUtils.assertIllegalArgumentException(() -> client.connect(-1, "localhost", res -> {
        }));
        TestUtils.assertIllegalArgumentException(() -> client.connect(65536, "localhost", res -> {
        }));
    ...
    public void testConnectInvalidHost() {
        TestUtils.assertNullPointerException(() -> client.connect(80, null, res -> {
        }));
    ...
    public void testConnectInvalidConnectHandler() throws Exception {
        TestUtils.assertNullPointerException(() -> client.connect(80, "localhost", null));
    }
